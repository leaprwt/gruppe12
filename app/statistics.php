...
<head>
    ...
    <link rel="stylesheet" href="/app/statistics.css" />
    <title>Study Companion | Statistiken</title>
</head>
<body>
<header>
    ...
    <main>
        <div>
            <h2>Statistik | Studiplaner</h2>
            <?php
                require_once "app/studyPlaner/statistics.inc.php";
            ?>
        </div>
        <div>
            <h2>Statistik | Bibliothek</h2>
            <?php
                require_once "app/library/statistics.inc.php";
            ?>
        </div>
        <div>
            <h2>Statistik | Mensaplan</h2>
            <?php
                require_once "app/mealPlan/statistics.inc.php";
            ?>
        </div>
    </main>
